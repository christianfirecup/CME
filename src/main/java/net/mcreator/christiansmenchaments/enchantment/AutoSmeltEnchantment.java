...
public class AutoSmeltEnchantment extends ChristiansMEnchamentsModElements.ModElement {
	@ObjectHolder("christians_m_enchaments:auto_smelt")
	public static final Enchantment enchantment = null;

	public AutoSmeltEnchantment(ChristiansMEnchamentsModElements instance) {
		super(instance, 3);
	}

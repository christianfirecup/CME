...
public class LifeStealEnchantment extends ChristiansMEnchamentsModElements.ModElement {
	@ObjectHolder("christians_m_enchaments:life_steal")
	public static final Enchantment enchantment = null;

	public LifeStealEnchantment(ChristiansMEnchamentsModElements instance) {
		super(instance, 7);
	}
